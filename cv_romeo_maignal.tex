...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{\hrefWithoutArrow{https://github.com/maignal}{{\footnotesize\faGithub}\hspace*{0.13cm}github.com/maignal    }}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:rmaignal@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}rmaignal@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm% \mbox{\hrefWithoutArrow{tel:+33-6-95-75-99-98}{{\footnotesize\faPhone*}\hspace*{0.13cm}+33 6 95 75 99 98}}%
    \end{header}

    \vspace{0.2 cm}
    I am a Computer Science student at EPFL and a Research Assistant at the DATA Lab. I am particularly interested in leveraging functional programming paradigms within Rust to build robust applications such as Embedded Systems, Operating Systems and high-performance CLI tools.

    \section{Education}
        \textbf{ETH Zurich}\hfill Zurich, Switzerland\\
        Master in Computer Science\hfill Sept 2026 - ongoing
        \begin{highlights}
            \item Relevant coursework: Data-Management Systems, Cloud Computing Architecture, Big Data, Advanced ML/DL, System Security, High-Performance Computing, Advanced Operating Systems, Principles of Distributed Computing
        \end{highlights}
        ...
        \begin{highlights}
            \item Relevant coursework: Computer Architecture, Computer Systems \& Network, Intro to ML, Software Construction, Digital System Design, OOP, Data-Intensive Systems, Computer Language Processing, Parallelism and Concurrency
        \end{highlights}
	...
	\textbf{EPFL DATA Laboratory}\href{https://www.epfl.ch/labs/data/research/}{}\hfill Lausanne, Switzerland\\
	{Research Assistant} \hfill Febr 2026 - June 2026
	\begin{highlights}
		\item Implemented the interpretation of SPARQL for the superfluid database management system.
        \item Wrote a Parser that transformed queries into an interpretable Abstract Syntax Tree that I then transformed to its Datalog equivalent.
        \item Optimized SPARQL-specific predicates throughout the DBMS pipeline.
	\end{highlights}
    ...
    \section{Notable Projects}
        \textbf{Aircraft Flights Tracking Software}\href{https://github.com/maignal/Javions}{}
        \begin{highlights}
        ...
        % \textbf{Conway's Game-of-Life in RISC-V Assembly}\href{https://github.com/maignal/Conway-s-Game-of-Life-in-RISC-V-Assembly}{}
        % \begin{highlights}
        ...
        \begin{highlights}
            \item Built a small robot capable of locating and tracking a person within a room, using both sound recognition and computer vision.
            \item Tools used: Raspberry Pi, Esp32, Python, OnShape, Prusa-Slicer
        \end{highlights}
        \textbf{Scala Web App}\href{https://github.com/maignal/Scala-Web-App}{}
        \begin{highlights}
            \item Multiplayer web game application. It Implements a famous board game and uses a client-server architecture to connect multiple players. Made use of Scala state machines and json serialization/deserialization functions.
        ...
        % \textbf{Haystack Store File System}\href{https://github.com/maignal/haystack-store}{}
        % \begin{highlights}
        ...
        \textbf{Roguelike Java Game}\href{https://github.com/maignal/Rogue-Like-Game-MP2-2022}{}
        \begin{highlights}
        ...
        % \textbf{Image Compressor / Decompressor}\href{https://github.com/maignal/Image-Compressor-Decompressor}{}
        % \begin{highlights}
    ...
    \section{Competences}
    \textbf{Programming Languages:} Rust, Scala, Java, Python, TypeScript/React, C, CUDA C++, Go, RISC-V Assembly, Verilog, LaTeX

    \vspace{0.2 cm}

    \textbf{Tools:} Git, Github, Vim, Linux, VSCode, Overleaf, GTKWave, OnShape, Blender

    \vspace{0.2cm}

    \textbf{Skills:} Functional Programming, Systems/Network Programming, Low-Level Programming, High Performance Parallel Programming, Algorithms, Data Structures, CI/CD, Web Developement

    \vspace{0.2cm}

    \textbf{Languages:} French (Native), English (C1 - IELTS), Spanish (B1)
