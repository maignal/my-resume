...
\begin{document}
    ...
    \section{Competences}
    \textbf{Computer Languages:} Rust, Scala, Java, Python, TypeScript, C, Go, RISC-V Assembly, Verilog, LaTeX
    
    \vspace{0.2 cm}
    
    \textbf{Tools:} Git, Github, VSCode, IntelliJ, Overleaf, GTKWave, OnShape, Blender
